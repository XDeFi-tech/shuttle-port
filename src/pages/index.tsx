...
import useMarsDeposit from "@/hooks/useMarsDeposit";
import useMarsClaim from "@/hooks/useMarsClaim";
...
export default function Home() {
  ...
  // const claim = useMarsClaim({ amount: token1Amount });
  // console.log("claim", claim);

  // const { data: claimFeeEstimate } = useFeeEstimate({
  //   messages: claim.msgs,
  // });
  ...
  return (
    <main>
      ...
      /> */}
          ...
          <button
            onClick={onSubmit}
            disabled={!(swapFeeEstimate && swapFeeEstimate.fee) || isSwapping}
          >
